            ...
            >
                ...
                <Modal.Body>
                    <div className="space-y-6">
                        <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">CVU: 000000000000000000000000</p>
                ...
                <Modal.Footer>
                    <Button className='bg-slate-600' onClick={() => { navigator.clipboard.writeText('00000000000000000000000') }}>Copiar CVU</Button>
