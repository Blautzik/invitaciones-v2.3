                ...
                <div className="flex flex-col md:flex-row md:w-10/12 w-full justify-between items-center lg:items-start">
                    <div className="flex flex-col justify-center items-center w-5/12">
                        <div className="flex flex-col justify-center items-center ">
                            <div className='bg-white h-40 w-40 rounded-full flex justify-center items-center drop-shadow mb-8'>
                                <GiChurch className=" text-8xl text-slate-400 mb-5" />
                            </div>
                        ...
                        <div className="flex flex-col justify-center items-center">
                            ...
                            <a href="https://calendar.google.com/">
                                <button className={`${roboto.className} text-base text-center mt-2 mb-3 w-80 lg:w-64 bg-slate-600 hover:bg-white hover:text-slate-600 rounded-full py-2 px-8 text-slate-50 shadow-md`}>Agendar</button>
                            </a>
                    ...
                    <div className="flex flex-col justify-center items-center w-5/12">
                        ...
                        <div className="flex flex-col justify-center items-center">
                            ...
                            <div className="opacity-60 mt-5">
                                <Image src="/janoslogo.png" alt="Image description" width="150" height="100" />
                            </div>                  
                        </div>
                    </div>
                </div>
