    ...
    <div className={`${openSans.className} bg-violeta w-screen min-h-screen bg-opacity-80`}>
      <div className="mx-auto py-10 ">
        <div className="mx-auto flex flex-col items-center text-center w-[270px]">
          ...
          <p className="text-white text-md max-w-2xl font-[500] pt-2">
        ...
        <form className="py-4 space-y-4 mx-auto w-10/12" onSubmit={handleSubmit}>
          ...
          <h3 className="text-white text-md max-w-2xl font-[500] pl-2"> A que institución perteneces?</h3>
          <div className="flex items-center justify-center">
            ...
            >
              ...
              <option value="Ser Vital">Ser Vital</option>
              <option value="Carpe Diem">Carpe Diem</option>
              <option value="Arenales">Arenales</option>
              <option value="Frónesis">Frónesis</option>
              <option value="Ágape">Ágape</option>
              <option value="La Pampa">La Pampa</option>
              <option value="Olimpia">Olimpia</option>
              <option value="Staff medico">Staff medico</option>
              <option value="Staff talleristas">Staff talleristas</option>
...
export default FormularioEspecial;