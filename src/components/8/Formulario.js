            ...
            <div className="mx-auto py-10 ">
                ...
                <form className="py-4 space-y-4 mx-auto w-10/12" onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-center justify-center">
                        ...
                        <select name="select" className={`${inputCN} text-gray-500`} onChange={e => setMenu(e.target.value)}>
                            
                            <option value="Menú Principal" className="text-gray-500" selected>Menú Principal </option>
