    ...
    return (
        <div className='h-screen w-full'>
            <div className="h-full  w-full flex flex-col relative items-center justify-between bg-gray-600">
                <Image
                    src={'https://res.cloudinary.com/fedexx/image/upload/v1694437236/Honeymoon-in-paradise_v6kfqd.jpg'}
                    fill
                    quality={100}
                    style={imageStyle}
                    alt='portada'
                ...
                <div className='mt-11 text-center mx-10 flex flex-col items-center text-white opacity-100 z-30'>
                    ...
                    <div className={`${openSans.className} font-[500] leading-7`}>
                        ...
                        Podés colaborar con nuestra Luna de Miel realizando un depósito a nuestra cuenta o acceder a la lista de regalos.
                ...
                <div className={`${comfortaa.className} z-30 w-10/12 md:w-1/4 mb-24 opacity-70`}>
                    <Accordion open header="Datos Bancarios" className='bg-violeta'>
                        <div className={`${openSans.className} text-sm font-thin opacity-100`}>
                            <p className='pb-2'><strong>Titular: </strong> Matias Borat</p>
                            <p className='pb-2'><strong>CBU:</strong> 543213214512 </p>
                            <p className='pb-2'><strong>Alias: </strong> nos casamos ahora</p>
                            <p className='pb-2'><strong> CUIL: </strong> 20-25698456-2 <strong>DNI: </strong> 32.698.456</p>
                        </div>
