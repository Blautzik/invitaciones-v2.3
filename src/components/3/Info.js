...
const Info = ({ dia, lugar, direccion }) => {
    return (
        <div className="relative bg-[#f6f2e3]">
                    ...
                    <div className="flex flex-col justify-center items-center w-5/12">
                        ...
                        <div className="flex flex-col justify-center items-center">
                            ...
                            <a href='https://www.janoseventos.com/salones.php?q=janos-escobar' target="_blank">
                                <button className={`${roboto.className} text-base text-center mt-2 mb-3 w-80 lg:w-64 bg-slate-600 lg:hover:bg-white lg:hover:text-slate-600 rounded-full py-2 px-8 text-slate-50 shadow-md`}>Conocé el salón</button>
                            </a>
